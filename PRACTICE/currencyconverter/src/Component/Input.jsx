...
const Input = ({label , amount , onamountchange , datakeys , resultamount  , onresultamountchange , disable , oncurrencychange}) => {
  console.log(datakeys? datakeys : "RUN");
  ...
  {/* Helper text */}
  <p className="mt-2 text-xs text-gray-500">Enter amount and select currency</p>
</div>
  )
}
